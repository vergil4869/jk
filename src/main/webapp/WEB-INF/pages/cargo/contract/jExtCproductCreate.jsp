...
<li id="back"><a href="../contract/list.action">返回</a></li>
</ul>
    </div>
</div>
</div>
    ...
    <div>
		<table class="commonTable" cellspacing="1">
	            ...
	            <td class="tableContent">
	            	...
	            	<option value="">--请选择--</option>
	            		<c:forEach items="${ctypeList}" var="c">
	            			<option value="${c.orderNo }">${c.name }</option>
	            		</c:forEach>
	            	</select>
	            </td>
	        ...
	        <tr>
	            ...
	            <td class="tableContent"><textarea type="text" style="height:120px;" name="productRequest"></textarea></td>
	            <td class="columnTitle_mustbe">货物描述：</td>
	            <td class="tableContent"><textarea type="text" style="height:120px;" name="productDesc"></textarea></td>
	        </tr>
		</table>
	</div>
</div>
